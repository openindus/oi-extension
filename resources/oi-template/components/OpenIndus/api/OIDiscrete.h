...
class OIDiscrete : public OIModule
{
...
private:
    ...
    static void IRAM_ATTR _discrete_isr_handler(void* arg);
...
class OIDiscrete : public OISubModule
{
public:

    OIDiscrete(uint8_t id) : OISubModule(id) {}
    ...
    inline void attachInterrupt(Etor_t etor, void (*callback)(void), InterruptMode_t mode) {
        ...
        FUNCTION.add(OIMessage(CMD_ETOR_INTERRUPT, _destId), [this](OIMessage msg) -> uint32_t {
