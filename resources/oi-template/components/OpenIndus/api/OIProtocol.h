...
enum {
    ...
    /* get */
    CMD_ANALOG_READ_ADC =           CMD_TYPE_GET(0x03),
    CMD_GET_ANALOG_ADC_REFERENCE =  CMD_TYPE_GET(0x04),
    CMD_GET_ANALOG_ADC_MODE =       CMD_TYPE_GET(0x05),
    CMD_GET_ANALOG_ADC_RESOLUTION = CMD_TYPE_GET(0x06),
    CMD_GET_ANALOG_DAC_MODE =       CMD_TYPE_GET(0x07),
    CMD_GET_CURRENT_DAC_MODE =      CMD_TYPE_GET(0x08),
};
