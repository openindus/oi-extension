...
#define OICORE_DEFAULT_I2C_SPEED        (100000UL)
...
public:
     ...
     */
    int digitalRead(Etor_t etor) const;
     ...
     */
    void attachInterrupt(Etor_t etor, void (*callback)(void *), void* args=NULL, InterruptMode_t mode=RISING);
...
private:
    ...
    static void _core_etor_isr_handler(void* arg);
};
...
class OISubCore: public OISubModule
{
public:

    OISubCore(uint8_t id) : OISubModule(id) {}
