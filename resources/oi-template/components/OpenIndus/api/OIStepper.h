...
class OIStepper : public OIModule
{
public:
...
class OIStepper : public OISubModule
{
public:

    OIStepper(uint8_t id) : OISubModule(id) {}
    ...
    **/
    inline void attachBusyInterrupt(void (*callback)(void)) {
        ...
        FUNCTION.add(OIMessage(CMD_BUSY_INTERRUPT, _senderId), [callback](OIMessage msg) -> uint32_t {
            callback();
            return 0;
        });
    }
    ...
    **/
    inline void attachErrorHandler(void (*callback)(uint16_t)) {
        ...
        FUNCTION.add(OIMessage(CMD_ERROR_HANDLER, _senderId), [callback](OIMessage msg) -> uint32_t {
    ...
    **/
    inline void attachFlagInterrupt(void (*callback)(void)) {
        ...
        FUNCTION.add(OIMessage(CMD_FLAG_INTERRUPT, _senderId), [callback](OIMessage msg) -> uint32_t {
            callback();
            return 0;
        });
    }
