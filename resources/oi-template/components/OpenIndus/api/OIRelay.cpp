...
void OIRelay::init()
{
    ...
    gpio_set_level(OIRELAY_PIN_CMD_MOSFET, LOW);
    gpio_install_isr_service(0);
}

void OIRelay::deinit(void)
{
    OIModule::deinit();
}
...
void OIRelay::attachFunctions(void)
{
    OIModule::attachFunctions();

    FUNCTION.add(OIMessage(CMD_SET_RELAY, _id), [this](OIMessage msg) -> uint32_t { setOutput((Relay_t)msg.getConf(), (uint8_t)msg.getData()); return 0;});
}
